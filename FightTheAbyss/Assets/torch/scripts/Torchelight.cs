...
public class Torchelight : MonoBehaviour {
	...
	void Update () {
		...
		MainFlame.GetComponent<ParticleSystem>().emissionRate = IntensityLight*30f;
		BaseFlame.GetComponent<ParticleSystem>().emissionRate=IntensityLight*20f;
		Etincelles.GetComponent<ParticleSystem>().emissionRate=IntensityLight*12f;
		Fumee.GetComponent<ParticleSystem>().emissionRate=IntensityLight*18f;		
